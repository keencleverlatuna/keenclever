                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  'Choose the account where you want to deposit money.',
                                  style: TextStyle(
                                    color: Colors.white
                                        .withValues(
                                      alpha: 0.68,
...
class _GlassDepositButton extends StatelessWidget {
  final bool isDepositing;
  final VoidCallback onTap;

  const _GlassDepositButton({
    required this.isDepositing,
    required this.onTap,
  });
